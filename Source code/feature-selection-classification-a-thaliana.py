...
dataset = pd.read_csv("/kaggle/input/sequencedna/A.thaliana(PreProcessed).csv")
...
svm_4=Support_vector.predict(FP_FN_RF_3[feature_names[selected_features_svm]],axis=1))
...
if acc_rf_4 >= acc_svm_4 and acc_rf_4 >= acc_gb_4 :
    ...
    FP_FN_RF_3['rf_pre']=rf_4
    FP_FN_RF_3['match'] = np.where(FP_FN_GB_3['label'] == FP_FN_RF_3['rf_pre'], 'True', 'False')
    ...
    FP_FN_RF_3['label'] = FP_FN_RF_3['label']
    FP_FN_RF_3['svm_pre']=svm_4     
    FP_FN_RF_3['match'] = np.where(FP_FN_GB_3['label'] == FP_FN_RF_3['svm_pre'], 'True', 'False')
    ...
    FP_FN_RF_3['label'] = FP_FN_RF_3['label']
    FP_FN_RF_3['gb_pre']=gb_4
    FP_FN_RF_3['match'] = np.where(FP_FN_GB_3['label'] ==  FP_FN_RF_3['gb_pre'], 'True', 'False')

    FP_FN_GB_4= FP_FN_RF_3[FP_FN_GB_3['match']=='False']
    FP_FN_GB_4=FP_FN_GB_4.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_4))
    
    TP_TN_GB_4= FP_FN_RF_3[FP_FN_GB_3['match']=='True']
...
svm_6=Support_vector.predict(FP_FN_RF[feature_names[selected_features_svm]])
acc_svm_6=metrics.accuracy_score(FP_RF_5['label'],svm_6)*10
...
knn_7=knn.predict(FP_FN_RF_6[feature_names[selected_features_knn]])
acc_knn_7=metrics.accuracy_score(FP_FN_RF_6['label'],knn_7)*100

FP_FN_RF_6['label'] = FP_FN_RF_6['label']
FP_FN_RF_6['knn_pre']=knn_7
FP_FN_RF_6['match'] = np.where(FP_FN_RF_6['label'] ==  FP_FN_RF_6['knn_pre'], 'True', 'False')

FP_FN_KNN_7= FP_FN_RF_6[FP_FN_RF_6['match']=='False']
FP_FN_KNN_7=FP_FN_KNN_7.drop(['knn_pre','match'], axis=1)
print("K Nearest Neighbor_FP_FN: ",len(FP_FN_KNN_7))
    
TP_TN_KNN_7= FP_FN_RF_6[FP_FN_RF_6['match']=='True']
TP_TN_KNN_7=TP_TN_KNN_7.drop(['knn_pre','match'], axis=1)
print("K Nearest Neighbor_TN_TP: ",len(TP_TN_KNN_7))

#Total Accuracy
print("Accuracy: ",(len(TP_TN_SVM_1)+len(TP_TN_SVM_2)+len(TP_TN_RF_3)+len(TP_TN_GB_4)+
                    len(TP_TN_RF_5)+len(TP_TN_RF_6)+len(TP_TN_KNN_7)/len(X_test))
