...
dataset = pd.read_csv("/kaggle/input/sequencedna/R.chinensis(PreProcessed).csv")
...
if acc_rf_2 >= acc_svm_2 and acc_rf_2 >= acc_gb_2 :
    ...
    FP_FN_RF_1['match'] = np.where(FP_FN_GB_1['label'] == FP_FN_RF_1['rf_pre'], 'True', 'False')

    FP_FN_RF_2=FP_FN_GB_1[FP_FN_GB_1['match']=='False']
    FP_FN_RF_2=FP_FN_RF_2.drop(['rf_pre','match'], axis=1)
    print("RF Provides best accuracy")
    print("Random_Forest_FP_FN: ",len(FP_FN_RF_2))
    
    TP_TN_RF_2=FP_FN_GB_1[FP_FN_GB_1['match']=='True']
    ...
    FP_FN_RF_1['match'] = np.where(FP_FN_GB_1['label'] == FP_FN_RF_1['svm_pre'], 'True', 'False')

    FP_FN_SVM_2=FP_FN_GB_1[FP_FN_GB_1['match']=='False']
    FP_FN_SVM_2=FP_FN_SVM_2.drop(['svm_pre','match'], axis=1)
    print("SVM Provides best accuracy")
    print("SVM_FP_FN: ",len(FP_FN_SVM_2))
    
    TP_TN_SVM_2=FP_FN_GB_1[FP_FN_GB_1['match']=='True']
    ...
    FP_FN_RF_1['match'] = np.where(FP_FN_GB_1['label'] ==  FP_FN_RF_1['gb_pre'], 'True', 'False')
    
    FP_FN_GB_2= FP_FN_RF_1[FP_FN_GB_1['match']=='False']
    FP_FN_GB_2=FP_FN_GB_2.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_2))
    
    TP_TN_GB_2= FP_FN_RF_1[FP_FN_GB_1['match']=='True']
...
if acc_rf_3 >= acc_svm_3 and acc_rf_3 >= acc_gb_3 :
    ...
    FP_FN_SVM_2['match'] = np.where(FP_FN_RF_2['label'] == FP_FN_SVM_2['rf_pre'], 'True', 'False')
    ...
    FP_FN_SVM_2['match'] = np.where(FP_FN_RF_2['label'] == FP_FN_SVM_2['svm_pre'], 'True', 'False')
    ...
    FP_FN_SVM_2['match'] = np.where(FP_FN_RF_2['label'] ==  FP_FN_SVM_2['gb_pre'], 'True', 'False')

    FP_FN_GB_3= FP_FN_SVM_2[FP_FN_RF_2['match']=='False']
    FP_FN_GB_3=FP_FN_GB_3.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_3))
    
    TP_TN_GB_3= FP_FN_SVM_2[FP_FN_RF_2['match']=='True']
...
knn.fit(train5[feature_names[selected_features_knn]], train5['label'])
knn_5=knn.predict(FP_FN_GB_4[feature_names[selected_features_knn]])
acc_knn_5=metrics.accuracy_score(FP_FN_GB_4['label'],knn_5)*100

FP_FN_GB_4['label'] = FP_FN_GB_4['label']
FP_FN_GB_4['knn_pre']=knn_5
FP_FN_GB_4['match'] = np.where(FP_FN_GB_4['label'] ==  FP_FN_GB_4['knn_pre'], 'True', 'False')

FP_FN_KNN_5= FP_FN_GB_4[FP_FN_GB_4['match']=='False']
FP_FN_KNN_5=FP_FN_KNN_5.drop(['knn_pre','match'], axis=1)
print("K Nearest Neighbor_FP_FN: ",len(FP_FN_KNN_5))
    
TP_TN_KNN_5= FP_FN_GB_4[FP_FN_GB_4['match']=='True']
TP_TN_KNN_5=TP_TN_KNN_5.drop(['knn_pre','match'], axis=1)
print("K Nearest Neighbor_TN_TP: ",len(TP_TN_KNN_5))

#Total Accuracy
print("Accuracy: ",(len(TP_TN_RF_1)+len(TP_TN_SVM_2)+len(TP_TN_SVM_3)+len(TP_TN_GB_4)+len(TP_TN_KNN_5) /len(X_test))
