...
dataset = pd.read_csv("/kaggle/input/sequencedna/C.elegans(PreProcessed).csv")
...
rf_2=random_forest.predict(FP_FN_RF_1[feature_names[selected_features_rf]])
acc_rf_2=metrics.accuracy_score(FP_FN_RF_1['label'],rf_2)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train2[feature_names[selected_features_gb]], train2['label'])
gb_2=gb.predict(FP_FN_RF_1[feature_names[selected_features_gb]])
acc_gb_2=metrics.accuracy_score(FP_FN_RF_1['label'],gb_2)*100

Support_vector = SVC()
Support_vector.fit(train2[feature_names[selected_features_svm]], train2['label'])
svm_2=Support_vector.predict(FP_FN_RF_1[feature_names[selected_features_svm]])
acc_svm_2=metrics.accuracy_score(FP_FN_RF_1['label'],svm_2)*100

if acc_rf_2 >= acc_svm_2 and acc_rf_2 >= acc_gb_2 :
    FP_FN_RF_1['label'] = FP_FN_RF_1['label']
    FP_FN_RF_1['rf_pre']=rf_2
    FP_FN_RF_1['match'] = np.where(FP_FN_RF_1['label'] == FP_FN_RF_1['rf_pre'], 'True', 'False')

    FP_FN_RF_2=FP_FN_RF_1[FP_FN_RF_1['match']=='False']
    FP_FN_RF_2=FP_FN_RF_2.drop(['rf_pre','match'], axis=1)
    print("RF Provides best accuracy")
    print("Random_Forest_FP_FN: ",len(FP_FN_RF_2))
    
    TP_TN_RF_2=FP_FN_RF_1[FP_FN_RF_1['match']=='True']
    ...
    FP_FN_RF_1['label'] = FP_FN_RF_1['label']
    FP_FN_RF_1['svm_pre']=svm_2     
    FP_FN_RF_1['match'] = np.where(FP_FN_RF_1['label'] == FP_FN_RF_1['svm_pre'], 'True', 'False')

    FP_FN_SVM_2=FP_FN_RF_1[FP_FN_RF_1['match']=='False']
    FP_FN_SVM_2=FP_FN_SVM_2.drop(['svm_pre','match'], axis=1)
    print("SVM Provides best accuracy")
    print("SVM_FP_FN: ",len(FP_FN_SVM_2))
    
    TP_TN_SVM_2=FP_FN_RF_1[FP_FN_RF_1['match']=='True']
    ...
    FP_FN_RF_1['label'] = FP_FN_RF_1['label']
    FP_FN_RF_1['gb_pre']=gb_2
    FP_FN_RF_1['match'] = np.where(FP_FN_RF_1['label'] ==  FP_FN_RF_1['gb_pre'], 'True', 'False')
    
    FP_FN_GB_2= FP_FN_RF_1[FP_FN_RF_1['match']=='False']
    FP_FN_GB_2=FP_FN_GB_2.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_2))
    
    TP_TN_GB_2= FP_FN_RF_1[FP_FN_RF_1['match']=='True']
...
rf_4=random_forest.predict(FP_FN_SVM_3[feature_names[selected_features_rf]])
acc_rf_4=metrics.accuracy_score(FP_FN_SVM_3['label'],rf_4)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train4[feature_names[selected_features_gb]], train4['label'])
gb_4=gb.predict(FP_FN_SVM_3[feature_names[selected_features_gb]])
acc_gb_4=metrics.accuracy_score(FP_FN_SVM_3['label'],gb_4)*100

Support_vector = SVC()
Support_vector.fit(train4[feature_names[selected_features_svm]], train4['label'])
svm_4=Support_vector.predict(FP_FN_SVM_3[feature_names[selected_features_svm]])
acc_svm_4=metrics.accuracy_score(FP_FN_SVM_3['label'],svm_4)*100

if acc_rf_4 >= acc_svm_4 and acc_rf_4 >= acc_gb_4 :
    FP_FN_SVM_3['label'] = FP_FN_SVM_3['label']
    FP_FN_SVM_3['rf_pre']=rf_4
    FP_FN_SVM_3['match'] = np.where(FP_FN_SVM_3['label'] == FP_FN_SVM_3['rf_pre'], 'True', 'False')

    FP_FN_RF_4=FP_FN_SVM_3[FP_FN_SVM_3['match']=='False']
    FP_FN_RF_4=FP_FN_GB_4.drop(['rf_pre','match'], axis=1)
    print("RF Provides best accuracy")
    print("Random_Forest_FP_FN: ",len(FP_FN_RF_4))
    
    TP_TN_RF_4=FP_FN_SVM_3[FP_FN_SVM_3['match']=='True']
    ...
    FP_FN_SVM_3['label'] = FP_FN_SVM_3['label']
    FP_FN_SVM_3['svm_pre']=svm_4     
    FP_FN_SVM_3['match'] = np.where(FP_FN_SVM_3['label'] == FP_FN_SVM_3['svm_pre'], 'True', 'False')

    FP_FN_SVM_4=FP_FN_SVM_3[FP_FN_SVM_3['match']=='False']
    FP_FN_SVM_4=FP_FN_SVM_4.drop(['svm_pre','match'], axis=1)
    print("SVM Provides best accuracy")
    print("SVM_FP_FN: ",len(FP_FN_SVM_4))
    
    TP_TN_SVM_4=FP_FN_SVM_3[FP_FN_SVM_3['match']=='True']
    ...
    FP_FN_SVM_3['label'] = FP_FN_SVM_3['label']
    FP_FN_SVM_3['gb_pre']=gb_4
    FP_FN_SVM_3['match'] = np.where(FP_FN_SVM_3['label'] ==  FP_FN_SVM_3['gb_pre'], 'True', 'False')

    FP_FN_GB_4= FP_FN_SVM_3[FP_FN_SVM_3['match']=='False']
    FP_FN_GB_4=FP_FN_GB_4.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_4))
    
    TP_TN_GB_4= FP_FN_SVM_3[FP_FN_SVM_3['match']=='True']
...
rf_6=random_forest.predict(FP_FN_GB_5[feature_names[selected_features_rf]])
acc_rf_6=metrics.accuracy_score(FP_FN_GB_5['label'],rf_6)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train6[feature_names[selected_features_gb]], train6['label'])
gb_6=gb.predict(FP_FN_GB_5[feature_names[selected_features_gb]])
acc_gb_6=metrics.accuracy_score(FP_FN_GB_5['label'],gb_6)*100

Support_vector = SVC()
Support_vector.fit(train6[feature_names[selected_features_svm]], train6['label'])
svm_6=Support_vector.predict(FP_FN_GB_5[feature_names[selected_features_svm]])
acc_svm_6=metrics.accuracy_score(FP_FN_GB_5['label'],svm_6)*100

from sklearn.neighbors import KNeighborsClassifier
knn=KNeighborsClassifier(n_neighbors=7)
knn.fit(train6[feature_names[selected_features_knn]], train6['label'])
knn_6=knn.predict(FP_FN_GB_5[feature_names[selected_features_knn]])
acc_knn_6=metrics.accuracy_score(FP_FN_GB_5['label'],knn_6)*100

FP_FN_GB_5['label'] = FP_FN_GB_5['label']
FP_FN_GB_5['knn_pre']=knn_6
FP_FN_GB_5['match'] = np.where(FP_FN_GB_5['label'] ==  FP_FN_GB_5['knn_pre'], 'True', 'False')

FP_FN_KNN_6= FP_FN_GB_5[FP_FN_GB_5['match']=='False']
FP_FN_KNN_6=FP_FN_KNN_6.drop(['knn_pre','match'], axis=1)
print("K Nearest Neighbor_FP_FN: ",len(FP_FN_KNN_6))
    
TP_TN_KNN_6= FP_FN_GB_5[FP_FN_GB_5['match']=='True']
