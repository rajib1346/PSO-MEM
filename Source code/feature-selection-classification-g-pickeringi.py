...
dataset = pd.read_csv("/kaggle/input/sequencedna/G.pickeringi(PreProcessed).csv")
...
rf_2=random_forest.predict(FP_FN_GB_1[feature_names[selected_features_rf]])
acc_rf_2=metrics.accuracy_score(FP_FN_GB_1['label'],rf_2)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train2[feature_names[selected_features_gb]], train2['label'])
gb_2=gb.predict(FP_FN_GB_1[feature_names[selected_features_gb]])
acc_gb_2=metrics.accuracy_score(FP_FN_GB_1['label'],gb_2)*100

Support_vector = SVC()
Support_vector.fit(train2[feature_names[selected_features_svm]], train2['label'])
svm_2=Support_vector.predict(FP_FN_GB_1[feature_names[selected_features_svm]])
acc_svm_2=metrics.accuracy_score(FP_FN_GB_1['label'],svm_2)*100

if acc_rf_2 >= acc_svm_2 and acc_rf_2 >= acc_gb_2 :
    FP_FN_GB_1['label'] = FP_FN_GB_1['label']
    FP_FN_GB_1['rf_pre']=rf_2
    FP_FN_GB_1['match'] = np.where(FP_FN_GB_1['label'] == FP_FN_GB_1['rf_pre'], 'True', 'False')
    ...
    FP_FN_GB_1['label'] = FP_FN_GB_1['label']
    FP_FN_GB_1['svm_pre']=svm_2     
    FP_FN_GB_1['match'] = np.where(FP_FN_GB_1['label'] == FP_FN_GB_1['svm_pre'], 'True', 'False')
    ...
    FP_FN_GB_1['label'] = FP_FN_GB_1['label']
    FP_FN_GB_1['gb_pre']=gb_2
    FP_FN_GB_1['match'] = np.where(FP_FN_GB_1['label'] ==  FP_FN_GB_1['gb_pre'], 'True', 'False')
    
    FP_FN_GB_2= FP_FN_GB_1[FP_FN_GB_1['match']=='False']
    FP_FN_GB_2=FP_FN_GB_2.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_2))
    
    TP_TN_GB_2= FP_FN_GB_1[FP_FN_GB_1['match']=='True']
...
rf_3=random_forest.predict(FP_FN_GB_2[feature_names[selected_features_rf]])
acc_rf_3=metrics.accuracy_score(FP_FN_GB_2['label'],rf_3)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train3[feature_names[selected_features_gb]], train3['label'])
gb_3=gb.predict(FP_FN_GB_2[feature_names[selected_features_gb]])
acc_gb_3=metrics.accuracy_score(FP_FN_GB_2['label'],gb_3)*100

Support_vector = SVC()
Support_vector.fit(train3[feature_names[selected_features_svm]], train3['label'])
svm_3=Support_vector.predict(FP_FN_GB_2[feature_names[selected_features_svm]])
acc_svm_3=metrics.accuracy_score(FP_FN_GB_2['label'],svm_3)*100

if acc_rf_3 >= acc_svm_3 and acc_rf_3 >= acc_gb_3 :
    FP_FN_GB_2['label'] = FP_FN_GB_2['label']
    FP_FN_GB_2['rf_pre']=rf_3
    FP_FN_GB_2['match'] = np.where(FP_FN_RF_2['label'] == FP_FN_GB_2['rf_pre'], 'True', 'False')
    ...
    FP_FN_GB_2['label'] = FP_FN_GB_2['label']
    FP_FN_GB_2['svm_pre']=svm_3     
    FP_FN_GB_2['match'] = np.where(FP_FN_RF_2['label'] == FP_FN_GB_2['svm_pre'], 'True', 'False')
    ...
    FP_FN_GB_2['label'] = FP_FN_GB_2['label']
    FP_FN_GB_2['gb_pre']=gb_3
    FP_FN_GB_2['match'] = np.where(FP_FN_RF_2['label'] ==  FP_FN_GB_2['gb_pre'], 'True', 'False')

    FP_FN_GB_3= FP_FN_GB_2[FP_FN_RF_2['match']=='False']
    FP_FN_GB_3=FP_FN_GB_3.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_3))
    
    TP_TN_GB_3= FP_FN_GB_2[FP_FN_RF_2['match']=='True']
...
acc_rf_5=metrics.accuracy_score(FP_FN_RF_4['label'],rf_5)*100
...
knn_5=knn.predict(FP_FN_RF_4[feature_names[selected_features_knn]])
acc_knn_5=metrics.accuracy_score(FP_FN_RF_4['label'],knn_5)*100

FP_FN_RF_4['label'] = FP_FN_RF_4['label']
FP_FN_RF_4['knn_pre']=knn_5
FP_FN_RF_4['match'] = np.where(FP_FN_RF_4['label'] ==  FP_FN_RF_4['knn_pre'], 'True', 'False')

FP_FN_KNN_5= FP_FN_RF_4[FP_FN_RF_4['match']=='False']
FP_FN_KNN_5=FP_FN_KNN_5.drop(['knn_pre','match'], axis=1)
print("K Nearest Neighbor_FP_FN: ",len(FP_FN_KNN_5))
    
TP_TN_KNN_5= FP_FN_RF_4[FP_FN_RF_4['match']=='True']
TP_TN_KNN_5=TP_TN_KNN_5.drop(['knn_pre','match'], axis=1)
print("K Nearest Neighbor_TN_TP: ",len(TP_TN_KNN_5))

#Total Accuracy
print("Accuracy: ",(len(TP_TN_GB_1)+len(TP_TN_GB_2)+len(TP_TN_GB_3)+len(TP_TN_RF_4)+len(TP_TN_KNN_5) /len(X_test))
