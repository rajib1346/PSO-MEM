...
dataset = pd.read_csv("/kaggle/input/sequencedna/G.subterraneus(PreProcessed).csv")
...
print("Accuracy: ",(len(TP_TN_GB_1)+len(TP_TN_RF_2)+len(TP_TN_GB_3)+len(TP_TN_RF_4)+len(TP_TN_KNN_5) /len(X_test))
