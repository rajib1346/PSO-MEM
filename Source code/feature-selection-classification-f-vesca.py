...
dataset = pd.read_csv("/kaggle/input/sequencedna/F.vesca(PreProcessed).csv")
...
acc_rf_5=metrics.accuracy_score(FP_FN_GB_4['label'],rf_5)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train5[feature_names[selected_features_gb]], train5['label'])
gb_5=gb.predict(FP_FN_GB_4[feature_names[selected_features_gb]])
acc_gb_5=metrics.accuracy_score(FP_FN_GB_4['label'],gb_5)*100
...
if acc_rf_5 >= acc_svm_5 and acc_rf_5 >= acc_gb_5 :
    ...
    FP_FN_GB_4['rf_pre']=rf_5
    FP_FN_GB_4['match'] = np.where(FP_FN_GB_4['label'] == FP_FN_GB_4['rf_pre'], 'True', 'False')

    FP_FN_RF_5=FP_FN_GB_4[FP_FN_GB_4['match']=='False']
    FP_FN_RF_5=FP_FN_RF_5.drop(['rf_pre','match'], axis=1)
    print("RF Provides best accuracy")
    print("Random_Forest_FP_FN: ",len(FP_FN_RF_5))
    
    TP_TN_RF_5=FP_FN_GB_4[FP_FN_GB_4['match']=='True']
    ...
    FP_FN_GB_4['label'] = FP_FN_GB_4['label']
    FP_FN_GB_4['svm_pre']=svm_5     
    FP_FN_GB_4['match'] = np.where(FP_FN_GB_4['label'] == FP_FN_GB_4['svm_pre'], 'True', 'False')

    FP_FN_SVM_5=FP_FN_GB_4[FP_FN_GB_4['match']=='False']
    FP_FN_SVM_5=FP_FN_SVM_5.drop(['svm_pre','match'], axis=1)
    print("SVM Provides best accuracy")
    print("SVM_FP_FN: ",len(FP_FN_SVM_4))
    
    TP_TN_SVM_5=FP_FN_GB_4[FP_FN_GB_4['match']=='True']
    ...
    FP_FN_GB_4['label'] = FP_FN_GB_4['label']
    FP_FN_GB_4['gb_pre']=gb_5
    FP_FN_GB_4['match'] = np.where(FP_FN_GB_4['label'] ==  FP_FN_GB_4['gb_pre'], 'True', 'False')

    FP_FN_GB_5= FP_FN_GB_4[FP_FN_GB_4['match']=='False']
    FP_FN_GB_5=FP_FN_GB_5.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_5))
    
    TP_TN_GB_5= FP_FN_GB_4[FP_FN_GB_4['match']=='True']
...
acc_rf_6=metrics.accuracy_score(FP_FN_SVM_5['label'],rf_6)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train6[feature_names[selected_features_gb]], train6['label'])
gb_6=gb.predict(FP_FN_SVM_5[feature_names[selected_features_gb]])
acc_gb_6=metrics.accuracy_score(FP_FN_SVM_5['label'],gb_6)*100
...
if acc_rf_6 >= acc_svm_6 and acc_rf_6 >= acc_gb_6 :
    ...
    FP_FN_SVM_5['rf_pre']=rf_6
    FP_FN_SVM_5['match'] = np.where(FP_FN_SVM_5['label'] == FP_FN_SVM_5['rf_pre'], 'True', 'False')
    ...
    FP_FN_SVM_5['label'] = FP_FN_SVM_5['label']
    FP_FN_SVM_5['svm_pre']=svm_6     
    FP_FN_SVM_5['match'] = np.where(FP_FN_SVM_5['label'] == FP_FN_SVM_5['svm_pre'], 'True', 'False')
    ...
    FP_FN_SVM_5['label'] = FP_FN_SVM_5['label']
    FP_FN_SVM_5['gb_pre']=gb_6
    FP_FN_SVM_5['match'] = np.where(FP_FN_SVM_5['label'] ==  FP_FN_SVM_5['gb_pre'], 'True', 'False')

    FP_FN_GB_6= FP_FN_SVM_5[FP_FN_SVM_5['match']=='False']
    FP_FN_GB_6=FP_FN_GB_6.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_6))
    
    TP_TN_GB_6= FP_FN_SVM_5[FP_FN_SVM_5['match']=='True']
...
acc_rf_7=metrics.accuracy_score(FP_FN_RF_6['label'],rf_7)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train7[feature_names[selected_features_gb]], train7['label'])
gb_7=gb.predict(FP_FN_RF_6[feature_names[selected_features_gb]])
acc_gb_7=metrics.accuracy_score(FP_FN_RF_6['label'],gb_7)*100
...
if acc_rf_7 >= acc_svm_7 and acc_rf_7 >= acc_gb_7 :
    ...
    FP_FN_RF_6['rf_pre']=rf_7
    FP_FN_RF_6['match'] = np.where(FP_FN_RF_6['label'] == FP_FN_RF_6['rf_pre'], 'True', 'False')

    FP_FN_RF_7=FP_FN_RF_6[FP_FN_RF_6['match']=='False']
    FP_FN_RF_7=FP_FN_RF_7.drop(['rf_pre','match'], axis=1)
    print("RF Provides best accuracy")
    print("Random_Forest_FP_FN: ",len(FP_FN_RF_5))
    
    TP_TN_RF_7=FP_FN_RF_6[FP_FN_RF_6['match']=='True']
    ...
    FP_FN_RF_6['label'] = FP_FN_RF_6['label']
    FP_FN_RF_6['svm_pre']=svm_7     
    FP_FN_RF_6['match'] = np.where(FP_FN_RF_6['label'] == FP_FN_RF_6['svm_pre'], 'True', 'False')

    FP_FN_SVM_7=FP_FN_RF_6[FP_FN_RF_6['match']=='False']
    FP_FN_SVM_7=FP_FN_SVM_7.drop(['svm_pre','match'], axis=1)
    print("SVM Provides best accuracy")
    print("SVM_FP_FN: ",len(FP_FN_RF_6))
    
    TP_TN_SVM_7=FP_FN_RF_6[FP_FN_RF_6['match']=='True']
    ...
    FP_FN_RF_6['label'] = FP_FN_RF_6['label']
    FP_FN_RF_6['gb_pre']=gb_7
    FP_FN_RF_6['match'] = np.where(FP_FN_RF_6['label'] ==  FP_FN_RF_6['gb_pre'], 'True', 'False')

    FP_FN_GB_7= FP_FN_RF_6[FP_FN_RF_6['match']=='False']
    FP_FN_GB_7=FP_FN_GB_7.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_7))
    
    TP_TN_GB_7= FP_FN_RF_6[FP_FN_RF_6['match']=='True']
...
acc_rf_8=metrics.accuracy_score(FP_FN_RF_7['label'],rf_8)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train8[feature_names[selected_features_gb]], train8['label'])
gb_8=gb.predict(FP_FN_RF_7[feature_names[selected_features_gb]])
acc_gb_8=metrics.accuracy_score(FP_FN_RF_7['label'],gb_8)*100
...
if acc_rf_8 >= acc_svm_8 and acc_rf_8 >= acc_gb_8 :
    ...
    FP_FN_RF_7['rf_pre']=rf_8
    FP_FN_RF_7['match'] = np.where(FP_FN_RF_7['label'] == FP_FN_RF_7['rf_pre'], 'True', 'False')

    FP_FN_RF_8=FP_FN_RF_7[FP_FN_RF_7['match']=='False']
    FP_FN_RF_8=FP_FN_RF_8.drop(['rf_pre','match'], axis=1)
    print("RF Provides best accuracy")
    print("Random_Forest_FP_FN: ",len(FP_FN_RF_5))
    
    TP_TN_RF_8=FP_FN_RF_7[FP_FN_RF_7['match']=='True']
    TP_TN_RF_8=TP_TN_RF_8.drop(['rf_pre','match'], axis=1)
    train9 = pd.concat([train8, TP_TN_RF_8])
    print("Random_Forest_TN_TP: ",len(TP_TN_RF_8))

elif acc_svm_8>=acc_rf_8 and acc_svm_8>=acc_gb_8 :
    FP_FN_RF_7['label'] = FP_FN_RF_7['label']
    FP_FN_RF_7['svm_pre']=svm_8     
    FP_FN_RF_7['match'] = np.where(FP_FN_RF_7['label'] == FP_FN_RF_7['svm_pre'], 'True', 'False')

    FP_FN_SVM_8=FP_FN_RF_7[FP_FN_RF_7['match']=='False']
    FP_FN_SVM_8=FP_FN_SVM_8.drop(['svm_pre','match'], axis=1)
    print("SVM Provides best accuracy")
    print("SVM_FP_FN: ",len(FP_FN_RF_7))
    
    TP_TN_SVM_8=FP_FN_RF_7[FP_FN_RF_7['match']=='True']
    TP_TN_SVM_8=TP_TN_SVM_8.drop(['svm_pre','match'], axis=1)
    train9 = pd.concat([train8, TP_TN_SVM_8])
    print("SVM_TN_TP: ",len(TP_TN_SVM_8))
         
else:
    FP_FN_RF_7['label'] = FP_FN_RF_7['label']
    FP_FN_RF_7['gb_pre']=gb_8
    FP_FN_RF_7['match'] = np.where(FP_FN_RF_7['label'] ==  FP_FN_RF_7['gb_pre'], 'True', 'False')

    FP_FN_GB_8= FP_FN_RF_7[FP_FN_RF_7['match']=='False']
    FP_FN_GB_8=FP_FN_GB_8.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_8))
    
    TP_TN_GB_8= FP_FN_RF_7[FP_FN_RF_7['match']=='True']
...
acc_rf_9=metrics.accuracy_score(FP_FN_GB_8['label'],rf_9)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train9[feature_names[selected_features_gb]], train9['label'])
gb_9=gb.predict(FP_FN_GB_8[feature_names[selected_features_gb]])
acc_gb_9=metrics.accuracy_score(FP_FN_GB_8['label'],gb_9)*100
...
if acc_rf_9 >= acc_svm_9 and acc_rf_9 >= acc_gb_9 :
    ...
    FP_FN_GB_8['rf_pre']=rf_9
    FP_FN_GB_8['match'] = np.where(FP_FN_GB_8['label'] == FP_FN_GB_8['rf_pre'], 'True', 'False')

    FP_FN_RF_9=FP_FN_GB_8[FP_FN_GB_8['match']=='False']
    FP_FN_RF_9=FP_FN_RF_9.drop(['rf_pre','match'], axis=1)
    print("RF Provides best accuracy")
    print("Random_Forest_FP_FN: ",len(FP_FN_RF_5))
    
    TP_TN_RF_9=FP_FN_GB_8[FP_FN_GB_8['match']=='True']
    TP_TN_RF_9=TP_TN_RF_9.drop(['rf_pre','match'], axis=1)
    train10 = pd.concat([train9, TP_TN_RF_9])
    print("Random_Forest_TN_TP: ",len(TP_TN_RF_9))

elif acc_svm_9>=acc_rf_9 and acc_svm_9>=acc_gb_9 :
    FP_FN_GB_8['label'] = FP_FN_GB_8['label']
    FP_FN_GB_8['svm_pre']=svm_9     
    FP_FN_GB_8['match'] = np.where(FP_FN_GB_8['label'] == FP_FN_GB_8['svm_pre'], 'True', 'False')

    FP_FN_SVM_9=FP_FN_GB_8[FP_FN_GB_8['match']=='False']
    FP_FN_SVM_9=FP_FN_SVM_9.drop(['svm_pre','match'], axis=1)
    print("SVM Provides best accuracy")
    print("SVM_FP_FN: ",len(FP_FN_GB_8))
    
    TP_TN_SVM_9=FP_FN_GB_8[FP_FN_GB_8['match']=='True']
    TP_TN_SVM_9=TP_TN_SVM_9.drop(['svm_pre','match'], axis=1)
    train10 = pd.concat([train9, TP_TN_SVM_9])
    print("SVM_TN_TP: ",len(TP_TN_SVM_9))
         
else:
    FP_FN_GB_8['label'] = FP_FN_GB_8['label']
    FP_FN_GB_8['gb_pre']=gb_9
    FP_FN_GB_8['match'] = np.where(FP_FN_GB_8['label'] ==  FP_FN_GB_8['gb_pre'], 'True', 'False')

    FP_FN_GB_9= FP_FN_GB_8[FP_FN_GB_8['match']=='False']
    FP_FN_GB_9=FP_FN_GB_9.drop(['gb_pre','match'], axis=1)
    print("GB Provides best accuracy: ")
    print("Gradient_Boosting_FP_FN: ",len(FP_FN_GB_9))
    
    TP_TN_GB_9= FP_FN_GB_8[FP_FN_GB_8['match']=='True']
...
acc_rf_10=metrics.accuracy_score(FP_FN_SVM_9['label'],rf_10)*100

gb = GradientBoostingClassifier(random_state=10)
gb.fit(train10[feature_names[selected_features_gb]], train10['label'])
gb_10=gb.predict(FP_FN_SVM_9[feature_names[selected_features_gb]])
acc_gb_10=metrics.accuracy_score(FP_FN_SVM_9['label'],gb_10)*100

Support_vector = SVC()
Support_vector.fit(train10[feature_names[selected_features_svm]], train10['label'])
...
FP_FN_SVM_9['match'] = np.where(FP_FN_SVM_9['label'] ==  FP_FN_SVM_9['knn_pre'], 'True', 'False')

FP_FN_KNN_10= FP_FN_SVM_9[FP_FN_SVM_9['match']=='False']
FP_FN_KNN_10=FP_FN_KNN_10.drop(['knn_pre','match'], axis=1)
print("K Nearest Neighbor_FP_FN: ",len(FP_FN_KNN_10))
    
TP_TN_KNN_10= FP_FN_SVM_9[FP_FN_SVM_9['match']=='True']
